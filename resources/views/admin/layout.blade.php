...
<head>
    ...
    <meta name="description" content="Shahziab Hassan Portfolio">
    ...
    <!-- TITLE -->
    <title>Shahzaib Hassan - Dashboard</title>
...
<body class="app sidebar-mini ltr light-mode">
                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="index.html">
                            ...
                            <img src="{{asset('assets/images/logo2.gif')}}" class="header-brand-img toggle-logo" style="margin-top: 50px;margin-bottom:50px; width:50px;height:50px;"
                                alt="logo">
                            <img src="{{asset('assets/images/logo2.gif')}}" class="header-brand-img light-logo" style="margin-top: 50px;margin-bottom:50px; width:150px;height:150px;" alt="logo">
                            <img src="{{asset('assets/images/logo2.gif')}}" class="header-brand-img light-logo1" style="margin-top: 50px;margin-bottom:50px; width:150px;height:150px;"
                                alt="logo">
                        </a>
                        <!-- LOGO -->
                    </div>
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        class="side-menu__icon fe fe-folder"></i><span class="side-menu__label">Contact Details</span><i
                                        class="angle fe fe-chevron-right hor-angle"></i>
                                </a>
                            </li>
                            <li class="sub-category">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        ...
                                        class="side-menu__label">Posts</span><i
                                        class="angle fe fe-chevron-right"></i>
                                </a>
								<ul class="slide-menu">
									<li class="panel sidetab-menu">
										...
										<div class="panel-body tabs-menu-body p-0 border-0">
											<div class="tab-content">
												<div class="tab-pane active" id="side21">
													<ul class="sidemenu-list">
                                                        <li><a href="login.html" class="slide-item"> New Posts</a></li>
                                                        <li><a href="register.html" class="slide-item"> All Posts</a></li>
                                                        ...
                                                        <div class="Annoucement_card">
                                                            <div class="text-center">
                                                                <div>
                                                                    ...
                                                                    <div class="bg-layer">
                                                                        <img src="adminassets/adminassets/images/media/37.png" alt="img" class="text-center mx-auto">
                                                                    </div>
                                                    ...
                                                    <div class="main-chat-list tab-pane">
                                                        <div class="media border-0 px-1 new border-top-0">
                                                            <div class="main-img-user online">
                                                                <img alt="" src="adminassets/images/users/5.jpg">
                                                            </div>
                                                        ...
                                                        <div class="media border-0 px-1 new">
                                                            <div class="main-img-user">
                                                                <img alt="" src="adminassets/images/users/6.jpg"> <span>3</span>
                                                            </div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                                                        ...
                                                        <div class="media border-0 px-1 new">
                                                            <div class="main-img-user online"><img alt="" src="adminassets/images/users/9.jpg"></div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                                                        ...
                                                        <div class="media border-0 px-1 new">
                                                            <div class="main-img-user"><img alt="" src="adminassets/images/users/4.jpg"></div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                                                        ...
                                                        <div class="media border-0 px-1 new">
                                                            <div class="main-img-user"><img alt="" src="adminassets/images/users/21.jpg"></div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                                                        ...
                                                        <div class="media border-0 px-1 new">
                                                            <div class="main-img-user"><img alt="" src="adminassets/images/users/5.jpg"></div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                                                        ...
                                                        <div class="media border-0 px-1 new">
                                                            <div class="main-img-user"><img alt="" src="adminassets/images/users/3.jpg"></div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                                                        ...
                                                        <div class="media border-0 px-1 new">
                                                            <div class="main-img-user"><img alt="" src="adminassets/images/users/7.jpg"></div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                                                        ...
                                                        <div class="media border-0 px-1 new border-bottom-0">
                                                            <div class="main-img-user"><img alt="" src="adminassets/images/users/6.jpg"></div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name">
                        ...
                        <div class="tab-pane" id="sidebar-side2">
                            <div class="list-group list-group-flush">
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="adminassets/images/users/2.jpg"></span>
                                    </div>
                                    <div class="">
                                        <a href="chat.html">
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="adminassets/images/users/11.jpg"><span
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="adminassets/images/users/10.jpg"></span>
                                    </div>
                                    <div class="">
                                        <a href="chat.html">
                                            <div class="fw-semibold text-dark" data-bs-toggle="modal"
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="adminassets/images/users/13.jpg"></span>
                                    </div>
                                    <div class="">
                                        <a href="chat.html">
                                            <div class="fw-semibold text-dark" data-bs-toggle="modal"
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="adminassets/images/users/12.jpg"><span
                                                class="avatar-status bg-success"></span></span>
                                    </div>
                                    <div class="">
                                        <a href="chat.html">
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="adminassets/images/users/15.jpg"></span>
                                    </div>
                                    <div class="">
                                        <a href="chat.html">
                                            <div class="fw-semibold text-dark" data-bs-toggle="modal"
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="adminassets/images/users/4.jpg"></span>
                                    </div>
                                    <div class="">
                                        <a href="chat.html">
                                            <div class="fw-semibold text-dark" data-bs-toggle="modal"
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="adminassets/images/users/7.jpg"><span
                                                class="avatar-status bg-success"></span></span>
                                    </div>
                                    <div class="">
                                        <a href="chat.html">
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="adminassets/images/users/9.jpg"></span>
                                    </div>
                                    <div class="">
                                        <a href="chat.html">
                                            <div class="fw-semibold text-dark" data-bs-toggle="modal"
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md brround cover-image"
                                            data-bs-image-src="adminassets/images/users/14.jpg"></span>
                                    </div>
                                    <div class="">
                                        <a href="chat.html">
                                            <div class="fw-semibold text-dark" data-bs-toggle="modal"
                        ...
                        <ul class="row p-3">
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block active">
                                    <span class="country-selector"><img alt="" src="adminassets/images/flags-img/us_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="adminassets/images/flags-img/italy_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="adminassets/images/flags-img/spain_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="adminassets/images/flags-img/india_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="adminassets/images/flags-img/french_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="adminassets/images/flags-img/russia_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="adminassets/images/flags-img/germany_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="adminassets/images/flags-img/argentina.jpg"
                                        class="me-3 language"></span>Argentina
                                </a>
                            </li>
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="" src="adminassets/images/flags-img/malaysia.jpg"
                                        class="me-3 language"></span>Malaysia
                                </a>
                            </li>
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="" src="adminassets/images/flags-img/turkey.jpg"
    ...
    <!-- CHART-CIRCLE JS-->
    <script src="{{asset('adminassets/js/circle-progress.min.js')}}"></script>

    <!-- PIETY CHART JS-->
    <script src="{{asset('adminassets/plugins/peitychart/jquery.peity.min.js')}}"></script>
    <script src="{{asset('adminassets/plugins/peitychart/peitychart.init.js')}}"></script>
    ...
    <script src="{{asset('adminassets/plugins/p-scroll/pscroll.js')}}"></script>
    <script src="{{asset('adminassets/plugins/p-scroll/pscroll-1.js')}}"></script>

    <!-- INTERNAL CHARTJS CHART JS-->
    <script src="{{asset('adminassets/plugins/chart/Chart.bundle.js')}}"></script>
    <script src="{{asset('adminassets/plugins/chart/utils.js')}}"></script>
    ...
    <script src="{{asset('adminassets/plugins/apexchart/irregular-data-series.js')}}"></script>

    <!-- INTERNAL Flot JS -->
    <script src="{{asset('adminassets/plugins/flot/jquery.flot.js')}}"></script>
    <script src="{{asset('adminassets/plugins/flot/jquery.flot.fillbetween.js')}}"></script>
    <script src="{{asset('adminassets/plugins/flot/chart.flot.sampledata.js')}}"></script>
    <script src="{{asset('adminassets/plugins/flot/dashboard.sampledata.js')}}"></script>

    <!-- INTERNAL Vector js -->
    <script src="{{asset('adminassets/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js')}}"></script>
	...
	<!-- TypeHead js -->
	<script src="{{asset('adminassets/plugins/bootstrap5-typehead/autocomplete.js')}}"></script>
    <script src="{{asset('adminassets/js/typehead.js')}}"></script>

    <!-- INTERNAL INDEX JS -->
    <script src="{{asset('adminassets/js/index1.js')}}"></script>
    ...
    <!-- Custom-switcher -->
    <script src="{{asset('adminassets/js/custom-swicher.js')}}"></script>
