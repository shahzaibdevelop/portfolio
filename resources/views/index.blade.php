			...
			<div class="centrize full-width" >
				<div class="vertical-center">
					<div class="spinner-logo" style="width:280px;height:auto;">
						<img src="assets/images/logo2.gif" alt="Shahzaib Hassan" >
          ...
          <div class="lui-started v-line v-line-left ">
                    ...
                    <br> --}}
    					...
    					<div class="slide scrolla-element-anim-1 scroll-animate" data-animate="active">
    						<img  src="assets/images/profile22.png" >
              ...
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                ...
                <div class="skills-items">
                  <div class="skills-item scrolla-element-anim-1 scroll-animate" data-animate="active">
                    ...
                    <div class="dots">
                      <div class="dot" style="width: {{$skills->percentage}}%;">
                        <span></span>
                      </div>
                    </div>
                    <div class="value">
                      <span class="num">{{$skills->percentage}} <span>%</span>
                      </span>
                    </div>
                  </div>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="testimonials-item">
                    <div class="image">
                      <img decoding="async" src="{{asset('testimonial_images/'.$tt->image)}}" alt="Barbara Wilson" >
                      <div class="icon">
